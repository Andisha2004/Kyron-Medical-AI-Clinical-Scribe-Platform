...
export function DashboardSidebar({ title, items, children }: DashboardSidebarProps) {
  return (
    <div className="mx-auto grid w-full max-w-7xl flex-1 grid-cols-1 md:grid-cols-[240px_1fr]">
      <aside className="border-b border-slate-200 bg-slate-50 p-5 md:border-r md:border-b-0">
